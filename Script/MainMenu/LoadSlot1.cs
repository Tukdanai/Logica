...
public class LoadSlot1 : MonoBehaviour, IPointerDownHandler
{
    ...
    void Start()
    {
        SaveFile = Application.persistentDataPath + Path.AltDirectorySeparatorChar + "SavedData1.json";
    ...
    private void SetCurrentPlayingSlot()
    {
        ...
        if(File.Exists(SaveFile1))
        {
            ...
            savedData1.isCurrentPlayingSlot = true;
        ...
        if(File.Exists(SaveFile2))
        {
            ...
            savedData2.isCurrentPlayingSlot = false;
